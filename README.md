...
nerva-jax is a minimal, transparent implementation of multilayer perceptrons using JAX tensors. Maintained by Manmohan S., it is part of the Nerva project - a suite of Python and C++ libraries that provide well-specified, inspectable implementations of neural networks.

All equations in this repository are written in batch (minibatch) matrix form, meaning feedforward, backpropagation, and loss functions operate on minibatches of inputs rather than single examples.
...
Note: nerva-sympy is intended for validation and testing - it depends on the other four.
...
Bug reports and contributions are welcome via the GitHub issue tracker. For specific inquiries regarding this implementation, please contact the maintainer.

---

## About the Maintainer

Manmohan S. is a Supply Chain Analyst and Python developer with over 4 years of experience in data analysis, SQL, and operational reporting. He maintains this repository to ensure a transparent and mathematically rigorous implementation of neural networks for research and educational purposes.
